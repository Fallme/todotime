...
- 计时圆环按顺时针显示已完成进度，支持快速完成本轮；未指派专注结束后可分配到已有任务或保留未指派。
...
- 13 套可同步主题：设置页一行显示当前主题，点击进入二级选择弹窗；默认番茄保持原样，并包含苹果极简、手绘纸张、强化像素、黑白秩序、苏联色块、3D 潮玩、赛博霓虹、抹茶自然、海洋蓝调、纸墨东方、日落暖橙和星夜深蓝。
