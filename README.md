...
- 计时圆环从满环开始，随倒计时顺时针逐步变空；“完成本轮”立即按完整计划时长结算，“跳过”仅跳过当前工作或休息阶段。
...
- 16 套可同步主题：设置页一行显示当前主题，点击进入二级选择弹窗；默认主题的计时器带番茄叶造型，并包含苹果极简、手绘纸张、强化像素、黑白秩序、苏联色块、3D 潮玩、油画质感、现代构成、简笔画、儿童蜡笔画、赛博霓虹、抹茶自然、海洋蓝调、纸墨东方和星夜深蓝。
