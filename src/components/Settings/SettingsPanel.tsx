...
const THEME_OPTIONS: Array<{
  ...
  { id: 'tarot', name: ['塔罗牌', 'Tarot'], description: ['神秘金线、星月符号与深蓝牌面', 'Mystic gold lines, moons and midnight cards'], colors: ['#b9934a', '#6d4ca5', '#14132c'] },
  ...
  { id: 'farmcraft', name: ['星露谷·泰拉', 'Farm & Terra'], description: ['田园冒险像素、泥土绿意与矿石色', 'Cozy farming pixels and underground adventure'], colors: ['#4f8f54', '#c7853c', '#f3d58a'] },
