...
const messages = {
  'zh-CN': {
    ...
    addCategory: '输入新分类名称', add: '添加', editCategory: '编辑分类', editCategoryHint: '点击标签旁的 ✎ 编辑名称和颜色，× 删除', delete: '删除', restore: '恢复', complete: '完成', abandon: '放弃',
    startPomodoro: '开始番茄', subtask: '子任务', keepOneCategory: '至少保留一个板块', keepOtherCategory: '「其他」用于未分配任务的专注，不可删除', deleteCategory: '删除板块', hideCategory: '点击隐藏该板块', showCategory: '点击显示该板块',
    feedback: '反馈', dataManagement: '数据管理', feedbackHint: '把你的建议或问题告诉我们，将一并存入你的数据仓库。', submitFeedback: '提交反馈', feedbackPlaceholder: '写下你的意见…', submitting: '提交中…', submit: '提交',
    ...
    today: '今天', todayPomodoros: '今日番茄', todayDuration: '今日时长', todayCompleted: '今日完成', lastSevenDays: '近七天', lastMonth: '近一个月', weeklyReport: '周报', monthlyReport: '月报',
    pomodoros: '番茄', duration: '时长', completedTasks: '完成任务', activeDays: '活跃天', combinedTrend: '综合走势', categoryShare: '板块占比', noData: '暂无数据', loadingStats: '正在加载统计…',
  ...
  en: {
    ...
    addCategory: 'New category name', add: 'Add', editCategory: 'Edit category', editCategoryHint: 'Click ✎ to edit a category, × to delete', delete: 'Delete', restore: 'Restore', complete: 'Complete', abandon: 'Drop',
    startPomodoro: 'Start focus', subtask: 'Subtask', keepOneCategory: 'Keep at least one category', keepOtherCategory: '“Other” is used for unassigned focus and cannot be deleted', deleteCategory: 'Delete category', hideCategory: 'Click to hide this category', showCategory: 'Click to show this category',
    feedback: 'Feedback', dataManagement: 'Data', feedbackHint: 'Tell us your suggestions or issues. It will be stored in your data repo.', submitFeedback: 'Submit feedback', feedbackPlaceholder: 'Write your feedback…', submitting: 'Submitting…', submit: 'Submit',
    ...
    today: 'Today', todayPomodoros: 'Today’s pomodoros', todayDuration: 'Today’s focus', todayCompleted: 'Completed today', lastSevenDays: 'Last 7 days', lastMonth: 'Last 30 days', weeklyReport: 'Weekly report', monthlyReport: 'Monthly report',
    pomodoros: 'Pomodoros', duration: 'Duration', completedTasks: 'Tasks done', activeDays: 'Active days', combinedTrend: 'Combined trend', categoryShare: 'Category share', noData: 'No data yet', loadingStats: 'Loading insights…',
