...
const messages = {
  'zh-CN': {
    ...
    timer: '计时器', workDuration: '工作时长（分钟）', shortBreakDuration: '短休息（分钟）', longBreakDuration: '长休息（分钟）', longBreakInterval: '长休息间隔（轮）',
  ...
  en: {
    ...
    timer: 'Timer', workDuration: 'Focus duration (min)', shortBreakDuration: 'Short break (min)', longBreakDuration: 'Long break (min)', longBreakInterval: 'Long break interval (rounds)',
