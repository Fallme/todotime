...
const messages = {
  'zh-CN': {
    ...
    feedback: '反馈', feedbackHint: '把你的建议或问题告诉我们，将一并存入你的数据仓库。', submitFeedback: '提交反馈', feedbackPlaceholder: '写下你的意见…', submitting: '提交中…', submit: '提交',
  ...
  en: {
    ...
    feedback: 'Feedback', feedbackHint: 'Tell us your suggestions or issues. It will be stored in your data repo.', submitFeedback: 'Submit feedback', feedbackPlaceholder: 'Write your feedback…', submitting: 'Submitting…', submit: 'Submit',
