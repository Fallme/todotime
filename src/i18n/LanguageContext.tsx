...
const messages = {
  'zh-CN': {
    ...
    startPomodoro: '开始番茄', subtask: '子任务', keepOneCategory: '至少保留一个板块', keepOtherCategory: '「其他」用于未分配任务的专注，不可删除', deleteCategory: '删除板块',
  ...
  en: {
    ...
    startPomodoro: 'Start focus', subtask: 'Subtask', keepOneCategory: 'Keep at least one category', keepOtherCategory: '“Other” is used for unassigned focus and cannot be deleted', deleteCategory: 'Delete category',
